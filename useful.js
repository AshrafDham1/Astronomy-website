...
var Game = function(Controller) {
    ...
    var velocityText = new Text(20, 20, '', null, '#000'); // Changed color to black
    var angleText = new Text(20, 40, '', null, '#000'); // Changed color to black
    // Rest of your code...

    // Bind 'n' key to new game function
    self.New = function() {
        self['new game']();
    };
